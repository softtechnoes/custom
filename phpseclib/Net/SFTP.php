 ...
 *
 *    $sftp = new \phpseclibcustom\Net\SFTP('www.domain.tld');
...
class SFTP extends SSH2
{
     ...
     *
     * \phpseclibcustom\Net\SSH2::exec() uses 0 and \phpseclibcustom\Net\SSH2::read() / \phpseclibcustom\Net\SSH2::write() use 1.
     *
    ...
    /**#@+
     * @access public
     * @see \phpseclibcustom\Net\SFTP::put()
    */
    /**
     ...
     * see \phpseclibcustom\Net\SFTP::_parseLongname() for an explanation
     *
     * @var array
     */
     ...
     * @param int $port
     * @param int $timeout
     * @return \phpseclibcustom\Net\SFTP
     * @access public
     */
    function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        // http://tools.ietf.org/html/draft-ietf-secsh-filexfer-13#section-7.1
        // the order, in this case, matters quite a lot - see \phpseclibcustom\Net\SFTP::_parseAttributes() to understand why
    ...
    function _init_sftp_connection()
    {
        ...
        /*
         ...
         in draft-ietf-secsh-filexfer-13 would be quite impossible.  As such, what \phpseclibcustom\Net\SFTP would do is close the
    ...
    function chdir($dir)
    {
        ...
        // see \phpseclibcustom\Net\SFTP::nlist() for a more thorough explanation of the following
        $response = $this->_get_sftp_packet();
        switch ($this->packet_type) {
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \phpseclibcustom\Net\SFTP::realpath().
     ...
     *
     * By default, \phpseclibcustom\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \phpseclibcustom\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     * @return bool
     * @access public
     * @internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \phpseclibcustom\Net\SFTP::setMode().
     */
